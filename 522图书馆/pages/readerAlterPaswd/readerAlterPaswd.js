// pages/readerAlterPaswd/readerAlterPaswd.js
Page({
  ...
  handleAdd: function (ev) {
    ...
    var renewpwd = that.data.renewpwd
    var id = parseInt(bar_code);
    wx.request({
      url: 'http://localhost:8080/UserInfo?dispatch=updatePassword' + '&UserId=' + id + '&Password=' + renewpwd,
      method: 'get',
      success: function (result) {
